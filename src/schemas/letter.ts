...
/**
 * Structured letter schema for formal document drafting
 * 
 * This schema enforces a strict document structure suitable for
 * business letters, legal documents, and formal correspondence.
 * 
 * Structure:
 * - Header (logo + organization details)
 * - Optional confidentiality notice
 * - Recipient address
 * - Optional accessibility notice
 * - Date
